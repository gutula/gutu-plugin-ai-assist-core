...
const nestedRoot = join(repoRoot, "framework/builtin-plugins/ai-assist-core");
...
if (failures.length > 0) {
  console.error("Documentation check failed for gutu-plugin-ai-assist-core:");
...
console.log("Documentation check passed for gutu-plugin-ai-assist-core.");
