...
export async function BusinessAdminPage() {
  ...
  return React.createElement(
    "section",
    null,
    React.createElement("h1", null, "AI Assist Control Room"),
    React.createElement("p", null, "AI-generated summaries, routing suggestions, anomaly posture, and operator-review visibility."),
    React.createElement(
      "p",
      null,
