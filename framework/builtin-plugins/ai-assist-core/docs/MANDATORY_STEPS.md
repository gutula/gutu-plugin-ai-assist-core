# AI Assist Core Mandatory Steps

## Before shipping a change

1. Update the public contract docs in `README.md` and `DEVELOPER.md`.
2. Keep the nested docs under `framework/builtin-plugins/ai-assist-core/docs` synchronized with the same truth.
...
1. Depend on the manifest ID `ai-assist-core` and the package import `@plugins/ai-assist-core`.
