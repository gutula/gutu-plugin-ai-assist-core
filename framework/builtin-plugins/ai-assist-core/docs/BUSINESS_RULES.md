# AI Assist Core Business Rules

## Invariants

- The plugin remains authoritative only for the data declared in `ai-assist-core` and its owned resource set.
...
- ERP parity references are tracked against: `CRM`, `Support`, `Projects`.

## Lifecycle notes

- This plugin currently exports 3 action(s), 3 resource(s), 2 job definition(s), and 1 workflow definition(s).
- The domain catalog currently tracks 4 owned entity surface(s), 3 report surface(s), and 3 exception queue(s).
